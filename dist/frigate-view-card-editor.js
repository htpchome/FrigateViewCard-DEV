    ...
    ${t.map(({value:o,label:n,disabled:s=!1,disabledReason:d=""})=>{const c=ye(o),h=ye(n),p=P(d),g=s===!0;return`<label class="theme-scope-opt card-view-start-opt" data-disabled-guidance="${p}"${g&&p?` title="${p}"`:""}>
      ...
      <div class="setting-content">
        ...
        <div class="settings-more-slot">
          ...
          ${U?`<label class="editor-swipe-choice-footer"><span>Include ${ie} Cards on Other Dashboard Pages</span><ha-switch id="ha_dashboard_swipe_include_other_cards" ${this._config?.ha_dashboard_swipe_include_other_cards?"checked":""} ${g&&z?"":"disabled"}></ha-switch></label>`:""}
          ...
          <span>${_}</span>
        </label>`).join(""),ia=l=>l===m.mobileView?"Mobile":l===m.preview?"Preview":l===m.wideView?"Wide View":l===m.cardView?"Card View":"Single View",xi=oe(this._config,D.desktop).map(l=>({value:l,label:ia(l)})),Si=this._standaloneLandingPageRoutes().map(l=>({value:l,label:ia(l)})),Ci={[b.mobile]:"Mobile",[b.card]:"Card View",[b.previewMobile]:"Preview + Mobile",[b.previewSingle]:"Preview + Single View",[b.single]:"Single View"},ki=Rt(this._config).map(l=>({value:l,label:Ci[l]})),Oe=(l,_)=>`<ha-formfield label="${_}">
          <ha-switch data-active-tab="${l}" ${Q.has(l)?"":"checked"}></ha-switch>
        </ha-formfield>`,Ei=$t.map(l=>{const _=l.key,y=this._themeDefaultHex(_,G),z=_e(li[_]),U=_e(ci[_]),ke=z||U||y,ae=di[_]===!0,$e=ae?y:ke,ct=!ae&&$e!==y;return`
        ...
        </div>`}).join(""),Ai=[{value:"light",label:"Light",icon:"mdi:white-balance-sunny"},{value:"dark",label:"Dark",icon:"mdi:weather-night"},{value:"both",label:"Both",icon:"mdi:theme-light-dark"}].map(({value:l,label:_,icon:y})=>{const z=ni===l;return`<button
          type="button"
      ...
      <div class="settings-container">
        ...
        ${this._renderSettingsPanel({id:"theme",title:"Theme Settings",icon:"mdi:palette",content:zi,active:B==="theme"})}
        ${this._renderSettingsPanel({id:"layout",title:"Layout Settings",icon:"mdi:angle-right",content:Oi,active:B==="layout"})}
